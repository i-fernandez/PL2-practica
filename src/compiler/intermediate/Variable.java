    ...
    implements VariableIF 
{
    ...
    /**
     * @return Nivel de anidamiento de la variable
     */
    public int getLevel ()
    {
    	Scope s = (Scope) scope;
    ...
    {
        // Busca en la tabla de simbolos del ambito
    	SymbolIF si = scope.getSymbolTable().getSymbol(name);
    	if (si instanceof SymbolVariable) return ((SymbolVariable) si).getAddress();
    	else if (si instanceof SymbolParameter) return ((SymbolParameter) si).getAddress();
    	return 0;
    }
